        ...
        <div className="border-t-4 border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-center md:text-left mb-6 md:mb-0">
              <p className="classic-title text-lg">
                © 2024 Indian Sign Language Academy
              </p>
              <p className="classic-subtitle text-sm mt-1">
                All Rights Reserved • Established for Educational Excellence
              </p>
            </div>
            <div className="flex space-x-6">
              <div className="w-12 h-12 bg-gray-800 border-2 border-gray-600 flex items-center justify-center hover:bg-gray-700 transition-colors cursor-pointer">
